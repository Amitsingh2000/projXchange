      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl mb-8 border border-white/20">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <span className="px-4 py-2 bg-gradient-to-r from-blue-100 to-teal-100 text-blue-700 rounded-full text-sm font-bold">
                    {project.category}
                  </span>
                  <span className="px-4 py-2 bg-gradient-to-r from-yellow-100 to-orange-100 text-orange-700 rounded-full text-sm font-bold flex items-center">
                    <Award className="w-3 h-3 mr-1" />
                    Featured
                  </span>
                </div>
                <div className="flex items-center gap-4">
                  <button className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-red-500 transition-colors rounded-xl hover:bg-red-50">
                    <Heart className="w-5 h-5" />
                    <span className="text-sm font-medium">{project.likes}</span>
                  </button>
                  <button className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-blue-500 transition-colors rounded-xl hover:bg-blue-50">
              ...
              {/* Video */}
              <div className="aspect-video bg-gray-900 rounded-2xl overflow-hidden mb-8 shadow-2xl">
                <iframe
              ...
              <div className="min-h-[400px]">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {project.techStack.map((tech, index) => (
                        <span key={index} className="px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 rounded-xl text-sm font-semibold shadow-sm">
                          {tech}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {project.features.map((feature, index) => (
                        <div key={index} className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl border border-blue-100">
                          <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-teal-500 rounded-full" />
                ...
                {activeTab === 'instructions' && (
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-2xl font-bold">Setup Instructions</h3>
                      {!isPurchased && (
                    ...
                    <div className={`${!isPurchased ? 'filter blur-sm' : ''}`}>
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {project.screenshots.map((screenshot, index) => (
                        <div key={index} className="aspect-video bg-gray-100 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow">
                          <img 
                            src={screenshot} 
          ...
          <div className="space-y-8">
            {/* Purchase Card */}
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl sticky top-8 border border-white/20">
              ...
              {!isPurchased ? (
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-teal-600 text-white py-4 rounded-xl font-bold text-lg hover:from-blue-700 hover:to-teal-700 transition-all duration-200 flex items-center justify-center gap-3 mb-6 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 rounded-xl font-bold text-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl">
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20">
              ...
              <button className="w-full mt-6 bg-gray-100 text-gray-800 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-colors">
                Contact Seller
              </button>
            </div>
                ...
                {relatedProjects.map((relatedProject) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-900 text-sm mb-2 group-hover:text-blue-600 transition-colors">{relatedProject.title}</h4>
                      <div className="flex items-center justify-between">
